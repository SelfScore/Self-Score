    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                setLoading(true);
                setError("");
                const response = await api.get("/api/level3/questions") as ApiResponse;
        ...
        >
            ...
            <Box sx={{ mb: 4 }}>
                ...
                >
                    ...
                    >
                        This comprehensive assessment measures your actionable growth and
                        personal development strategies. Answer each question honestly to
                        receive an accurate score.
                    </Typography>
                    ...
                    >
                        <li>Multiple Choice: Select the option that best describes you</li>
                        <li>
                            Slider: Rate yourself on a scale of 0-10 (0 = worst, 10 = best)
                        </li>
                    </Typography>
                </Box>
            </Box>
            ...
            >
                ...
                {isLastQuestion ? (
                    ...
                    <ButtonSelfScore
                        ...
                        disabled={
                            !currentQuestion ||
                            !(currentQuestion.questionId in answers)
                        }
                        background={
